...
@RabbitListener(
        ...
        @Queue(RabbitMQConfigTopic.QUEUE_TOPIC_TWO),
...
public class TopicConsumerTwo {
    ...
    public void executor(@Payload User msg, Channel channel, Message message, @Headers Map headers) throws IOException, InterruptedException {
        log.info("收到消息{} 队列 {} rouking >>> {} = {}", msg, headers.get(AmqpHeaders.CONSUMER_QUEUE), RabbitMQConfigTopic.ROUTING_KEY_TWO, msg.getUsername());
