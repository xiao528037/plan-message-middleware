...
@RabbitListener(
        ...
        @Queue(RabbitMQConfigDirect.QUEUE_DIRECT_TWO),
                exchange = @Exchange(value = RabbitMQConfigDirect.EXCHANGE_DIRECT), key = RabbitMQConfigDirect.ROUTING_KEY_TWO))
public class DirectConsumerThree extends Consumer {
